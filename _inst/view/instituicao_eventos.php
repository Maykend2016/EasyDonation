                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            ...
                            <div class="table-responsive ">
                                ...
                                <form action="../../_evento/crud/CRUDEvento.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    <label class="col-md-2 control-label">Código Identificação</label>
                                                    <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control input-md" name="titulo"  >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    <label class="col-md-2 control-label" >Capa do Evento</label>
                                                    <div class="col-md-4">
                                                        <input type="file" class="form-control input-md" name="img" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea cols="5" rows="30" type="text" class="form-control input-md" name="descricao"  ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    <label class="col-md-2 control-label" >Data de Evento</label>
                                                    <div class="col-md-4">
                                                        <input type="date" class="form-control input-md" name="dataagora" >
                                                    </div>
                                                </div>
                                            </div> 


                                            <input style="float: right" type="submit" class="a-menu-sair btn-sm btn-danger" name="cadastro_evento">
