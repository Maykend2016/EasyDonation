            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Localização  <small>Atualizar</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="glyphicon glyphicon-chevron-up "></i> Local
                        </li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control input-md" name="bairro"  placeholder=" Ex: Liberdade">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control input-md" name="rua"  placeholder=" Ex: Rua João Soares">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control input-md" name="numero"  placeholder=" Ex: 123">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <input style="float: right" type="submit" class="a-menu-sair btn-sm btn-danger" name="local_mudar">
