            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="demo" class="collapse">
                        ...
                        <li>
                            <a href="instituicao_eventos.php">Formar Evento</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Start Panel  <small>Bem vindo</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="glyphicon glyphicon-check "></i> Doar é Vida
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <img class="img-responsive img-rounded" src="../bootstrap/img/intro1.1.png" width="1700px"  >
