    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Doações  <small>Cadastrados</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="glyphicon glyphicon-user "></i> Cadastro
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <h4>Cadastro de Doações</h4>
                            <div class="table-responsive ">


                                <form action="../../_doacao/crud/CRUDDoacao.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="categoria" id="cod_categoria">
                                                            <option value=""></option>
                                                            <?php
                                                            $sql = "SELECT id, titulo_cat FROM easy_categoria ORDER BY titulo_cat ASC";
                                                            $pqs = $conn->query($sql);
                                                            $pqs->execute();
                                                            while ($row = $pqs->fetch()) {
                                                                echo '<option value="' . $row['id'] . '">' . utf8_encode($row['titulo_cat']) . '</option>';
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    <label class="col-md-2 control-label" for="subcategoria">Id Sub-categoria</label>
                                                    <div class="col-md-4">
                                                        <select name="subcategoria" id="cod_subcategoria" >
                                                            <option value="">-- Escolha catedoria --</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    <label class="col-md-2 control-label" for="ci">Imagem da Doação</label>
                                                    <div class="col-md-4">
                                                        <input type="file" class="form-control input-md" name="imgpadrao" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" class="form-control input-md" name="quantidade" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-horizontal">
                                                    <label class="col-md-2 control-label" for="data">Data de Doação</label>
                                                    <div class="col-md-4">
                                                        <input type="date" class="form-control input-md" name="data" >
                                                    </div>
                                                </div>
                                            </div> 


                                            <input style="float: right" type="submit" class="a-menu-sair btn-sm btn-danger" name="cadastro_doacao">
		...
		$(function(){
			$("#cod_categoria").change(function(){
                            alert($(this).val());
				if( $(this).val() ) {
					$('#cod_subcategoria').hide();
					$('.carregando').show();
					$.getJSON('subcategoria.ajax.php?search=',{cod_categoria: $(this).val(), ajax: 'true'}, function(j){
						var options = '<option value=""></option>';	
						for (var i = 0; i < j.length; i++) {
							options += '<option value="' + j[i].id + '">' + j[i].titulo_sub + '</option>';
						}	
						$('#cod_subcategoria').html(options).show();
						$('.carregando').hide();
					});
				} else {
					$('#cod_subcategoria').html('<option value="">– Escolha uma categoria –</option>');
				}
			});
		});
		</script>
