                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Doações  <small>Todas as doações</small>
                            </h1>
                            <ol class="breadcrumb">
                                <li class="active">
                            ...
                            <div class="col-md-11">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <table id="mytable" class="table table-bordred table-striped table-hover">
                                        ...
                                        $sql_list = "SELECT * FROM easy_doacao WHERE inst_CI = '$valor_CI' LIMIT " . $item . ", " . $itens_por_pagina . "";
                                        $execute = $conn->query($sql_list) or die($conn->error);
                                        $produto = $execute->fetch(PDO::FETCH_ASSOC);
                                        $num = $execute->rowCount();

                                        $num_total = $conn->query("SELECT * FROM easy_doacao WHERE inst_CI = '$valor_CI' ")->rowCount();
                                        ...
                                        if ($num > 0) {
                                            ...
                                            <td><img src="../../_doacao/crud/fotos/' . $produto['img_padrao'] . '" width="40" height="40"></td>
                                            <td id="' . $produto['id'] . '">' . $produto['id'] . '</td>
                                            <td>' . $produto['inst_CI'] . '</td>
                                            <td>' . $nome_cat . '</td>
                                            <td>' . utf8_encode($nome_sub) . '</td>
                                            <td>' . $produto['descricao'] . '</td>
                                            <td>' . $produto['quantidade'] . '</td>
                                            <td>' . $produto['data'] . '</td>
                                            <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></td>
                                            <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal"  data-target="#delete" onclick="deletaDoacao(' . $produto['id'] . ')" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
                                            </tr>';
